...
let AuthService = class AuthService {
    ...
    async validatePlatformUser(email, pass) {
        const [user] = await drizzle_1.db.select().from(drizzle_1.platformUsers).where((0, drizzle_orm_1.eq)(drizzle_1.platformUsers.email, email)).limit(1);
